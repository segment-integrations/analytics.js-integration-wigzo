...
var Wigzo = module.exports = integration('Wigzo')
  ...
  .tag('https_tracker', '<script src="https://tracker.wigzopush.com/gcm_http_subscribe.js?orgtoken={{ orgToken }}">');
...
Wigzo.prototype.initialize = function() {
  ...
  self.load('https_tracker'); // independent script
...
Wigzo.prototype.loaded = function() {
  return !!window.wigzo;// && !!window.wigoz.$ && !!window.wigzo.track && !!window.wigzo.index;
};
