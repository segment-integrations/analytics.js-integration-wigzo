...
/* AddToWishList event */
var sendAddToWishList = function(properties) {
  if (properties.hasOwnProperty('product_id')) {
    window.wigzo.track('wishlist', properties.product_id);
  }
};
...
Wigzo.prototype.track = function(track) {
  ...
  case 'Product Added to Wishlist' : sendAddToWishList(props); break;
  /* Product Reviewed  */
  case 'Product Viewed' :
